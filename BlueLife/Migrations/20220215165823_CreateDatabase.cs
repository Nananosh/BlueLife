        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameCatalogMedicine = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatalogMedicine", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineManufacturer", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineName", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReleaseMedicine", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyWarehouses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketMedicine", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasketMedicine_Baskets_BasketId",
                        column: x => x.BasketId,
                        principalTable: "Baskets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BasketMedicine_PharmacyWarehouses_PharmacyWarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketMedicine_BasketId",
                table: "BasketMedicine",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketMedicine_PharmacyWarehouseId",
                table: "BasketMedicine",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicine_MedicineNameId",
                table: "Medicine",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineName_CatalogMedicinesId",
                table: "MedicineName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderMedicine_PharmacyWarehouseId",
                table: "OrderMedicine",
                column: "PharmacyWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyWarehouses_ReleaseMedicineId",
                table: "PharmacyWarehouses",
                column: "ReleaseMedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_ReleaseMedicine_ManufacturerId",
                table: "ReleaseMedicine",
                column: "ManufacturerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReleaseMedicine_MedicineId",
                table: "ReleaseMedicine",
                column: "MedicineId");
        }
